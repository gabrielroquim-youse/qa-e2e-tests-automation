...
export const FRONTEND_CAPABILITIES: FrontendCapability[] = [
  ...
  },
  {
    ...
    testable: true,
    specs: [
      'ux/lead-info.spec.ts',
      'ux/vehicle-details.spec.ts',
      'ux/vehicle-additional.spec.ts',
      'ux/person-data.spec.ts',
      'ux/bonuses-class.spec.ts',
    ],
    planner: 'planner-validacao-campos.md',
    notes: 'Etapas 1–5: OBR, formato e-mail/telefone, placa, CEP/uso, CPF, bônus',
  },
  ...
  // ── data_enrichment ──
  {
    ...
    status: 'covered',
    testable: true,
    specs: ['ux/data-enrichment.spec.ts'],
    notes: 'Section no funil; QA pode auto-avançar sem formulário interativo',
  },
  ...
  },
  {
    ...
    status: 'covered',
    testable: true,
    specs: ['ux/plan-preformatted.spec.ts'],
    planner: 'planner-assistencias.md',
  },
  {
    id: 'CAP-34',
  ...
  // ── risk_acceptance ──
  {
    ...
    status: 'covered',
    testable: true,
    specs: ['ux/risk-acceptance.spec.ts'],
    notes: 'Perfil sem garagem noturna; QA pode auto-avançar para checkout',
  },
  ...
  },
  {
    ...
    status: 'covered',
    testable: true,
    specs: ['ux/checkout.spec.ts'],
    planner: 'planner.md',
    notes: 'Opcional no load · interação Adicionar residencial',
  },
  {
    id: 'CAP-39',
    section: 'checkout',
